    ...
    <div className='
      ...
      <div className='flex flex-row justify-center items-center xtsm:max-md:flex-col gap-20 md:max-lg:gap-8'>
        ...
        <div className='flex flex-col justify-center items-center mb-auto gap-16 '>
          <img src={PeopleTwo} alt="" className='w-full md:max-lg:mr-auto xtsm:max-md:w-3/4 md:max-lg:w-3/4'/>
          <p className='font-base my-auto mb-12 xtsm:max-md:font-normal text-lg xtsm:max-md:text-base  xtsm:max-md:mx-auto xtsm:max-md:w-auto xtsm:max-md:text-center'>We share common trends and strategies for improving your rental income and making sure you stay in high demand. With lots of unique blocks, you can easily build a page without coding. Build your next landing page.</p>
        </div>
      </div>
      <div className='flex flex-row xtsm:max-md:flex-col justify-center items-center gap-8 my-6'>
        <div className='flex flex-col justify-center items-center text-center gap-4'>
          ...
          <p className='font-bold text-base xtsm:max-sm:w-3/4'>Customers visit Omega every month to get their service done.</p>
        </div>
        <div className='flex flex-col justify-center items-center text-center gap-4'>
          <img src={GPA} alt="" className='w-2/6 ' />
          <p className='font-bold text-base xtsm:max-sm:w-3/4'>Satisfaction rate comes from our awesome customers.</p>
        </div>
        <div className='flex flex-col justify-center items-center text-center gap-4'>
          <img src={DivPercentage} alt="" className='w-1/6'/>
          <p className='font-bold text-base xtsm:max-sm:w-3/4'>Average customer ratings we have got all over internet.</p>
        </div>
      </div>
    </div>
  )
